...
export default function SingleToyRow({ toy }) {
  return (
    <div className="bg-black border-white mb-5 rounded-lg block sm:flex">
      ...
      <div className="view-details p-5 text-center flex items-center justify-center">
        <NavLink className="btn" to={`/toy/${toy?._id}`}>
          View Details
        </NavLink>
      </div>
    </div>
